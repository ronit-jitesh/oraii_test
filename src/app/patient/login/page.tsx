            ...
            <div className="w-full max-w-md">
                <div style={{ background: '#FFFFFF', borderRadius: 12, border: '1px solid #E2DDD5', boxShadow: '0 2px 12px rgba(45,106,79,0.08)', padding: 32 }}>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full pl-12 pr-4 py-3.5 font-medium" placeholder="you@example.com" required />
                            </div>
                        </div>
                        <div>
                    ...
                    <p className="text-center mt-8 font-medium" style={{ color: '#6B7280' }}>
                        ...
                        <Link href="/signup?role=patient" className="font-bold" style={{ color: '#2D6A4F' }}>Create Account</Link>
                    </p>
